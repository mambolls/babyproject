...
import com.baby.babyproject.util.ObjectUtils;
...
public class JedisUtil {
    ...
    public static String get(String key) {
        ...
        try {
            ...
            if (jedis.exists(key)) {
                value = jedis.get(key);
                value = ObjectHelper.isNotEmpty(value)
        ...
        try {
            ...
            if (jedis.exists(getBytesKey(key))) {
                ...
                for (Map.Entry<byte[], byte[]> e : map.entrySet()) {
                    value.put(ObjectUtils.toString(e.getKey()),
                            toObject(e.getValue()));
                }
